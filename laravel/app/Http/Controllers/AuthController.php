...
class AuthController extends Controller
{
    ...
    public function show($key)
    {
        ...
        if($user){
            ...
            $user -> tipo_usuario = $_user->hasRole('Usuaria/o')?'Usuaria/o':($_user->hasRole('Administrador')?'Administrador':($_user->hasRole('Super Administrador')?'Super Administrador':null));
        }
