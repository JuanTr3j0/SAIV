...
class OpcionesController extends Controller
{
    ...
    public function index(){
        try {
            ...
            // Casos
            $tiposViolencia         = getEnunms('tipo_violencias','tipo_violencia');    
            ...
            bitacora_errores('OpcionesController.php', $e);
    ...
    public function indexSeguimientoJuridico(){
        ...
        try{
                ...
                // Casos
                $tipo_violencia                             = getEnunms('tipo_violencias','tipo_violencia');  
